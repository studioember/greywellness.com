...
<div class="-mt-16 relative z-10 overflow-hidden -mx-4 sm:-mx-6" aria-hidden="true">
  <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="block w-full h-16" style="fill: hsl(var(--bg))">
...
<section class="bg-surface-warm pb-16 -mx-4 sm:-mx-6">
  ...
  <div class="-mt-16 relative z-10 overflow-hidden" aria-hidden="true">
    <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="block w-full h-16" style="fill: hsl(var(--surface-warm))">
...
<div class="-mt-1 overflow-hidden -mx-4 sm:-mx-6" aria-hidden="true">
  <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="block w-full h-12" style="fill: hsl(var(--surface-warm))">
